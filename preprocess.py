...
with open(DATA_PATH + 'random_walks_val.txt', 'r') as f:
    for line in f:
        ...
        graphs_val[walks[0]] = []
        for i in range(1, len(walks)):
            graphs_val[walks[0]].append([x for x in walks[i].split()])
...
with open(DATA_PATH + 'random_walks_test.txt', 'r') as f:
    for line in f:
        ...
        graphs_test[walks[0]] = []
        for i in range(1, len(walks)):
            graphs_test[walks[0]].append([x for x in walks[i].split()])

labels_train = {}
sizes_train = {}
with open(DATA_PATH + 'trainlabel.txt', 'r') as f:
    for line in f:
        profile = line.split('\t')
...
with open(DATA_PATH + 'vallabel.txt', 'r') as f:
    for line in f:
        profile = line.split('\t')
...
with open(DATA_PATH + 'testlabel.txt', 'r') as f:
    for line in f:
        profile = line.split('\t')
...
pickle.dump((x_data, y_data, sz_data, index.length()), open(DATA_PATH1 + 'datatest/data_train.pkl','wb'))
...
pickle.dump((x_data, y_data, sz_data, index.length()), open(DATA_PATH1 + 'datatest/data_val.pkl','wb'))
...
pickle.dump((x_data, y_data, sz_data, index.length()), open(DATA_PATH1 + 'datatest/data_test.pkl','wb'))
...
pickle.dump(node_vec, open(DATA_PATH1 + 'datatest/node_vec.pkl','wb'))
